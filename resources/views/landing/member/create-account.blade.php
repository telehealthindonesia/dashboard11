                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="project-info">
                            <h2 class="box-title">Pembuatan Akun</h2>
                            <form action="" method="post">
                                ...
                                <div class="row mb-1">
                                    <div class="col-md-4">
                                        <label>Exprd Passport</label>
                                    </div>
                                    <div class="col-md-8">
                                        <input type="date" class="form-control" name="exp_passport">
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col-md-4">
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" class="form-control" required name="nomor_telepon">
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary margin-top-20">Simpan</button>
                            </form>
